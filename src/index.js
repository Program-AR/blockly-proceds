...
export class BlocklyProceds {
  ...
  addParameter = (self) => {
    if(self.arguments_ === undefined) self.arguments_ = [] // TODO REVER
    const argsAmount = self.arguments_
